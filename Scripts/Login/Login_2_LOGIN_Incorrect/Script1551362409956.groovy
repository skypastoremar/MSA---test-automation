...
Mobile.setText(findTestObject('Text box/Username o indirizzo email'), 'prova', 30)
...
WebUI.waitForElementPresent(findTestObject('Allert Messages/Credenziali errate'), 30)

WebUI.verifyElementPresent(findTestObject('CTA/OK'), 30)

Mobile.tap(findTestObject('CTA/OK'), 60)
